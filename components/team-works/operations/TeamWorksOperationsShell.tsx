 ...
 */
function buildTeamWorksNavItems(labels: TeamWorksLabels): MikkeShellNavItem[] {
  return [
    ...
    { label: `${labels.workers}管理`, href: "/apps/team-works/partners", icon: Users, section: "運営" },
 ...
 */
function buildTeamWorksBottomNavItems(labels: TeamWorksLabels): MikkeShellBottomNavItem[] {
  return [
    { label: "ホーム", href: "/apps/team-works", icon: Home },
    ...
    { label: `${labels.workers}管理`, href: "/apps/team-works/partners", icon: Users }
  ];
}
...
export function TeamWorksOperationsShell({
  ...
  return (
    <MikkeAppShell
      ...
      navItems={buildTeamWorksNavItems(labels)}
      bottomNavItems={buildTeamWorksBottomNavItems(labels)}
      ownedApps={[]}
      otherApps={[]}
      suggestedApps={[]}
    >
