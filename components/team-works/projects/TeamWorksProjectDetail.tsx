...
function FormsAndResourcesTab({ projectId, reviewerId, forms, resources, roles, state, save }: {
  ...
  return <div className="grid gap-6 lg:grid-cols-2">
    {reviewError ? <p role="alert" className="rounded-lg border border-[var(--mikke-danger)] px-3 py-2 text-sm font-bold text-[var(--mikke-danger)] lg:col-span-2">{reviewError}</p> : null}
...
function TasksTab({
  ...
  return (
    <div className="space-y-6">
      {assignmentError ? <p role="alert" className="rounded-lg border border-[var(--mikke-danger)] px-3 py-2 text-sm font-bold text-[var(--mikke-danger)]">{assignmentError}</p> : null}
