...
export function TeamWorksWorkerProjectsShell({ title, subtitle, children }: { title: string; subtitle: string; children: React.ReactNode }) {
  ...
  return (
    <MikkeAppShell appName="Team Works" title={title} subtitle={subtitle} currentApp={{ label: "Team", href: "/apps/team-works/portal/worker/projects", icon: FolderKanban }} theme="green" footerLabel="Team Works by mikke">
