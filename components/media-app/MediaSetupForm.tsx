...
export function MediaSetupForm() {
  ...
  function submit(event: React.FormEvent) {
    ...
    setError("");
    try {
      createMediaSite({ ownerProfileId: profile.id, name, slug, description, authorName });
