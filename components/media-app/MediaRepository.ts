...
type Repository = Methods & {cloud:boolean; publishMediaArticle(id:string,attestation?:MediaPublicationAttestation):Promise<ReturnType<typeof local.publishMediaArticle>>};
...
function repository(cloud: boolean, expectedSubject: string): Repository {
  ...
  return {...methods,cloud,async publishMediaArticle(id,attestation){
