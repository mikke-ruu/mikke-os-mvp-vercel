...
function BillingWorkspace({ userId, headquartersId, legacy, isGuest }: Props) {
  ...
  return <div className="space-y-3"><AcademyFirstPublicationPanel identityKey={userId} state={view.status} access={view.access} allowedActions={cancelAllowed ? ["cancel_conversion"] : []} onRefresh={load} onAction={async action => {
