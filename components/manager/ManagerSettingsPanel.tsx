...
export function ManagerSettingsPanel() {
  ...
  return (
    <ManagerShell title="設定" subtitle="Managerとアプリメニューの見え方を調整します。">
      ...
      <section className="mt-5 rounded-2xl border border-[var(--mikke-line)] bg-white p-4 shadow-sm">
        <Link href="/manager/history" className="block py-1 text-sm font-bold text-[var(--mikke-primary)]">
          履歴を見る
        </Link>
        <p className="mt-1 text-xs leading-5 text-[var(--mikke-muted)]">最近の動きを確認できます。</p>
      </section>
