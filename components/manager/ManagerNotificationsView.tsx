  ...
  return (
    <ManagerShell title="お知らせ" subtitle="各アプリで、確認や対応が必要なものをまとめて見ます。">
      <div className="grid gap-4 xl:grid-cols-2">
        <section id="manager-tasks" className="scroll-mt-20 rounded-xl border border-[var(--mikke-line)] border-t-[3px] border-t-[var(--mikke-orange)] bg-[var(--mikke-surface)] p-3 shadow-sm sm:rounded-2xl sm:p-4">
        ...
        <section id="manager-progress" className="scroll-mt-20 rounded-xl border border-[var(--mikke-line)] border-t-[3px] border-t-[var(--mikke-green)] bg-[var(--mikke-surface)] p-3 shadow-sm sm:rounded-2xl sm:p-4">
