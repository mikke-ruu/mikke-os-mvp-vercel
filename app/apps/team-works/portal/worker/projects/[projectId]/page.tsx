...
export default function TeamWorksWorkerProjectDetailPage() {
  ...
  return <AuthGate><TeamWorksWorkerProjectsShell title="担当プロジェクト詳細" subtitle="自分に割り当てられた工程とタスクを確認する"><TeamWorksWorkerProjectDetail projectId={params.projectId} /></TeamWorksWorkerProjectsShell></AuthGate>;
}
