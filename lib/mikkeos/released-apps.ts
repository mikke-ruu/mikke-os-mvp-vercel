...
export const academyApp: MikkeMenuAppDefinition = { appKey: "academy", title: "Academy", href: "/academy", icon: GraduationCap, tone: "pink" };
...
export const releasedApps: MikkeMenuAppDefinition[] = [marketNoteApp, storyApp, academyApp, communityApp];
