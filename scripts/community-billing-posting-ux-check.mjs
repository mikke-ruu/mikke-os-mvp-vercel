...
const checks = [
  ...
  [app.includes("hasApprovedExternalPayment") && app.includes("plan.externalCustomerPortalUrl && hasApprovedExternalPayment"), "portal link is not shown for manual or unrelated entitlements"],
