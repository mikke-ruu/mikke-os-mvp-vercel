...
const returned = read("app/billing/return/page.tsx");
const card = read("components/billing/PlatformBillingReturnCard.tsx");

for (const [source, canonical] of [[success, "/billing/success"], [cancel, "/billing/cancel"], [returned, "/billing/return"]]) {
...
assert.match(card, /\u3053\u306e\u753b\u9762\u304c\u8868\u793a\u3055\u308c\u305f\u3060\u3051\u3067\u306f\u5951\u7d04\u72b6\u614b\u306f\u5909\u308f\u308a\u307e\u305b\u3093/);
